...
describe('Candles Testing', () => {
  describe('Bullish / Bearish detection', () => {
    ...
    it('Should be bearish (2)', (done) => {
      const candle = new Candle({
        base:'BTC', close:20986.02, counter:'EUR', high:20996.02, low:20969.45, open:20977.4, openTimeInISO:'2022-10-29T16:08:00.000Z', openTimeInMillis:1667059680000, productId:'BTC-EUR', sizeInMillis:null, volume:0.66249251
      });
      assert.strictEqual(candle.isBearish, true);
      assert.strictEqual(candle.isBullish, false);
      done();
